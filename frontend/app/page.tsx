...
export default function Phase0SeamCheck() {
  ...
  return (
    ...
    >
      <header>
        ...
        <h1 style={{ margin: "0.35rem 0", fontSize: "2rem", fontWeight: 600 }}>
          SOP Opera
        </h1>
        <p style={{ color: "var(--muted)", margin: 0 }}>
          Foundation seam check — shared contracts, REST ping, WebSocket echo,
          fixtures.
        </p>
      </header>
