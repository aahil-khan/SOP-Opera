...
*Source: `backend/app/context/derived_facts.py` (rules), `backend/app/db/seed_embeddings.py:207-289` (SOPs), `backend/app/reviews/concerns.py` (supervisor concern mapping)*
